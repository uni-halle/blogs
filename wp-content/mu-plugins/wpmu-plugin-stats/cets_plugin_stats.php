		...
		*/
		...
		function load_scripts() {
			...
			if ( $screen->id == $this->page . '-network' ) {
				wp_register_script( 'tablesort', plugins_url('js/tablesort-2.4.min.js', str_replace('/srv/www/wordpress/wp-content','/srv/www/wordpress/wp-base/wp-content/',__FILE__ )), array(), '2.4', true);
