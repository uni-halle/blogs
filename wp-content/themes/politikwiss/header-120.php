...
<html lang="de">
<head>
<link rel="icon" type="image/png" href="<?php echo esc_url( get_template_directory_uri() );?>/img/fav120.png">
<meta charset="UTF-8" />
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="description" content="Willkommen auf der Startseite des politikwissenschaftlichen Masterstudiengangs Parlamentsfragen und Zivilgesellschaft der Martin-Luther-Universität Halle-Wittenberg. Hier erhalten Sie alle Informationen rund um den Studiengang in Halle (Saale). " />
<title>
		<?php bloginfo('name', '  ');
		wp_title();?>
</title>
...
<link rel="stylesheet" type="text/css" media="screen" href="<?php echo esc_url( get_template_directory_uri() );?>/style_120.css">
  ...
  <header>
   ...
   <div class="container logowrap">
    <ul class="sr-only">
        ...
        <div class="logo">
        <a href="/masterpolitikwissenschaften/?p=15"><img src="<?php echo esc_url( get_template_directory_uri() );?>/img/logo_120.svg" alt="Masterstudium 
