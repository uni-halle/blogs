...
<div id="header">
	<div class="sleeve">
		...
		<h1><a href="<?php bloginfo( 'url' ); ?>/"><?php bloginfo( 'name' ); ?></a></h1>
		   ...
		   {
		   ?> 
            <p class="login ">Hi <strong> <a href="<?php echo get_option('siteurl');?>/wp-admin/profile.php"><?php echo $userinfo['display_name']; ?></a></strong>, | <a href="<?php echo get_option('home'); ?>/wp-admin/">Dashboard</a> | <a href="<?php echo get_option('siteurl');?>/wp-admin/post-new.php">Add Post</a> | <a href="<?php echo get_option('siteurl');?>/wp-login.php?action=logout&_wpnonce=">Logout</a> </p>
