...
function kreative_page_menu() 
{
	...
	add_submenu_page('kreative_page_general', __('Advertisement Settings'), __('Advertisement'), 6, 'kreative_page_ads', 'kreative_page_ads');
...
function kreative_page_ads() 
{
	kreative_init_option('ads');
}
