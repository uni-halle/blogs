...
<?php the_category(', ') ?></span><br /><span class="bubble"><?php comments_popup_link(__('Leave a Comment','avenue'), __('One Comment','avenue'), __('% Comments','avenue'), '', __('Comments off','avenue')); ?></span></p>

<?php if ( is_home() ) { ?><div class="divider"></div><?php } ?>
