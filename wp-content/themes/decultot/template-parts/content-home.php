...
<?php
// begin on frontpage show last three posts of Aktuelles/News (future posts)
//	if(is_front_page()) :

		$catID = ICL_LANGUAGE_CODE === 'de' ? 5 : 9;
		$title = ICL_LANGUAGE_CODE === 'de' ? 'Aktuelle Veranstaltungen' : 'Upcoming events';
		$args = array(
				'post_type' => 'post',
				'cat' => $catID,
				'post_status' => 'future',
...
<!--		<h2>--><?php //echo get_cat_name($catID);?><!--</h2>-->
		...
		<?php
//	endif;
// end on frontpage show last three posts of Aktuelles/News
