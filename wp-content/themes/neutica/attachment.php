...
<?php the_content(''.__('Read More <span class="meta-nav">&raquo;</span>', 'sandbox').''); ?>
					...
					<div>
						<?php ps_previous_image_link( '<span style="float:left;display:inline">%link</span>' ) ?>
						<?php ps_next_image_link( '<span style="float:right;display:inline">%link</span>' ) ?>
					</div>

					</div>
					<div class="entry-meta">
						<ul class="attachment-meta-list meta-list">
							<li><span class="parent-title">Back to <a href="<?php echo get_permalink($post->post_parent) ?>" rev="attachment"><?php echo get_the_title($post->post_parent) ?></a></span></li>
						</ul>
