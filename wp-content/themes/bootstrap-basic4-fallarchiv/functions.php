 ...
 */
if (is_admin()) {
  require get_stylesheet_directory() . '/inc/classes/Bsb4Acf.php';

  $bsb4Acf = new \BootstrapBasic4\Bsb4Acf();
  $bsb4Acf->addActionsFilters();
  unset($bsb4Acf);
}

require get_stylesheet_directory() . '/inc/classes/Bsb4Sidebars.php';
$bsb4Sidebars = new \BootstrapBasic4\Bsb4Sidebars();
$bsb4Sidebars->addActionsFilters();
unset($bsb4Sidebars);

require_once get_stylesheet_directory() . '/inc/classes/Bsb4Design.php';
require_once get_stylesheet_directory() . '/inc/classes/Bsb4Utilities.php';
require_once get_stylesheet_directory() . '/inc/classes/Bsb4SearchAndFilter.php';

add_action('after_setup_theme', 'my_child_theme_locale');

// Load translation files from your child theme instead of the parent theme
function my_child_theme_locale() {
  load_child_theme_textdomain('bootstrap-basic4', get_stylesheet_directory() . '/languages');
}
...
function theme_enqueue_styles() {
  ...
  wp_enqueue_style('sidebars-style', get_stylesheet_directory_uri() . '/css/sidebars.css');
