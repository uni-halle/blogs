...
<html class="no-js" <?php language_attributes(); ?>>
    <head>
		...
		<link href="https://fonts.googleapis.com/css?family=Lora:400,400i,700|Source+Sans+Pro:300,400" rel="stylesheet"> 
        ...
        <div class="container page-container">
            <header class="page-header page-header-sitebrand-topbar">
                <div class="row row-with-vspace site-branding">
	                 <div class="col-6">
	                <a href="http://uni-halle.de" target="_blank"><img class="links" src="<?php echo (get_stylesheet_directory_uri().'/images/mlu_siegel.png')?>" height="40px" /></a>
                </div>
                <div class="col-6">
	                <a href="http://www.zlb.uni-halle.de/qlb" target="_blank"><img class="rechts" src="<?php echo (get_stylesheet_directory_uri().'/images/logo_kalei.jpg')?>" height="30px"></a>
                </div>
