    ...
    <?php endif ?>	
      ...
      if ($replik):
              ...
              <div class="card">
                ...
                <div id="collapse1a" class="collapse" role="tabpanel" aria-labelledby="heading1a">
                  <div class="card-block"> 
                      ...
                      <ul class="dateien">         
                        <?php
                        while (have_rows('dateien')): the_row();
                          // vars                 
                          ...
                          ?>                 
                          <li class="datei">                         
                            <p class="klein"><?php if ($titel_datei) {
                            echo $titel_datei;
                          } ?> | 
                        <?php if ($datei_datei): ?>
        ...
        <?php if ($textblock = get_field('textblock')): ?><?= $textblock ?> <?php endif ?>  
          ...
          <?php
          while (have_rows('replik')): the_row();
            // vars                 
      ...
      <?php endif; ?>
        ...
        <?php if (have_rows('autor')): ?> 	
            ...
            <?php if ($nachname) {
              echo $nachname;
            } ?> <!-- | <?php if ($status = get_the_term_list($post->ID, 'status', ' ')): ?><?= $status ?><?php endif ?> --> | <?php if ($mail) {
              echo $mail;
            } ?>
                          </div>         
          <?php endwhile; ?>         
