	...
	<body <?php if(!empty($_GET['dir'])){ $dir = $_GET['dir']; } else { $dir = ''; } body_class("body " . $dir); ?>>
		<div class="body__background">
			<div class="body__backgroundupper body__backgroundupper--typo">
				<div class="body__backgroundupperinner" style="background-image: url(http://behnelux.de/vorschau/winckelmann/wp-content/uploads/2017/12/banner.jpg); background-size: cover; background-position: center center;">
