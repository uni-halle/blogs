...
function my_post_gallery($output, $attr) {
	...
	if ($attr["type"] == "masonry") {
		...
		foreach ($attachments as $id => $attachment) {
			...
			$output .= "<div class='contentgallerymasonry__item contentgallerymasonry__item--" . $columns . "columns'>";
	...
	if ($attr["type"] == "slider") {
		...
		if (count($attachments) > 1) {
			foreach ($attachments as $id => $attachment) {
				...
				$controls .= "<span class='contentgalleryslider__controltext'>Bild " . $count . " von " . count($attachments) . " </span>";
		...
		if (count($attachments) > 1) {
			foreach ($attachments as $id => $attachment) {
				...
				$controlcaptionmix .= "<span class='contentgalleryslider__controlitem contentgalleryslider__controltext'>Bild " . $count . " von " . count($attachments) . " </span>";
				if($count == count($attachments)) { 
