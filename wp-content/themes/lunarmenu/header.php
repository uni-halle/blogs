...
<?php if ( is_page() || is_single() || is_archive() || is_search() || is_404() ) { ?>
<div class="home"><a href="<?php echo get_settings('home'); ?>" title="<?php bloginfo('name'); ?> Home"><img src="<?php bloginfo('template_directory'); ?>/images/home.jpg" alt="Home" /></a></div><!-- End Home --><?php } ?>
