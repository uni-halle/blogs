...
if ( ! class_exists( 'Inkthemes_About_Page' ) ) {
	...
	require_once( get_template_directory() . '/plugin-notification/ti-notifications/functions/ti-notifications-utils.php' );
...
//			$this->tabs          = isset( $this->config['tabs'] ) ? $this->config['tabs'] : array();
		...
		public function get_plugin_icon( $arr ) {
			...
			if ( ! empty( $arr['svg'] ) ) {
				...
				$plugin_icon_url = get_template_directory_uri() . '/plugin-notification/ti-notifications/ti-about-page/images/placeholder_plugin.png';
			}
		...
		public function style_and_scripts( $hook_suffix ) {
			...
			wp_enqueue_style( 'ti-about-page-css', get_template_directory_uri() . '/plugin-notification/ti-notifications/ti-about-page/css/ti_about_page_css.css', array());

			if ( 'appearance_page_' . $this->theme_slug . '-welcome' == $hook_suffix ) {

				wp_enqueue_script( 'ti-about-page-js', get_template_directory_uri() . '/plugin-notification/ti-notifications/ti-about-page/js/ti_about_page_scripts.js', array( 'jquery' ));
		...
		public function dismiss_required_action_callback() {
			...
			if ( ! empty( $action_id ) ) {
				...
				if ( get_option( $this->theme_slug . '_required_actions' ) ) {
					...
					switch ( esc_html( wp_unslash($_GET['todo'] )) ) {
						case 'add':
