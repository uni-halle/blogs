 ...
 */
class Inkthemes_Customizer_Notify {
	...
	/**
	 * The single instance of Inkthemes_Customizer_Notify
	 *
	 * @var Inkthemes_Customizer_Notify $instance The Inkthemes_Customizer_Notify instance.
	 */
	...
	/**
	 * The Main Inkthemes_Customizer_Notify instance.
	 *
	 * We make sure that only one instance of Inkthemes_Customizer_Notify exists in the memory at one time.
	 *
	 * @param array $config The configuration array.
	 */
	public static function init( $config ) {
		if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Inkthemes_Customizer_Notify ) ) {
			self::$instance = new Inkthemes_Customizer_Notify;
	...
	public function setup_actions() {
		...
		add_action( 'customize_register', array( $this, 'inkthemes_customizer_notify_customize_register' ) );

		// Enqueue scripts and styles
		add_action( 'customize_controls_enqueue_scripts', array( $this, 'inkthemes_customizer_notify_scripts_for_customizer' ), 0 );

		/* ajax callback for dismissable recommended actions */
		add_action( 'wp_ajax_ti_customizer_notify_dismiss_recommended_action', array( $this, 'inkthemes_customizer_notify_dismiss_recommended_action_callback' ) );

		add_action( 'wp_ajax_ti_customizer_notify_dismiss_recommended_plugins', array( $this, 'inkthemes_customizer_notify_dismiss_recommended_plugins_callback' ) );

	}

	/**
	 * Scripts and styles used in the Inkthemes_Customizer_Notify class
	 */
	public function inkthemes_customizer_notify_scripts_for_customizer() {

		wp_enqueue_style( 'ti-customizer-notify-customizer-css', get_template_directory_uri() . 'plugin-notification/ti-notifications/ti-customizer-notify/css/ti-customizer-notify-customizer.css', array());
		...
		wp_enqueue_script( 'ti-customizer-notify-customizer-js', get_template_directory_uri() . '/plugin-notification/ti-notifications/ti-customizer-notify/js/ti-customizer-notify-customizer.js', array( 'customize-controls' ));
		wp_localize_script(
	 ...
	 */
	public function inkthemes_customizer_notify_customize_register( $wp_customize ) {

		/**
		 * Include the Inkthemes_Customizer_Notify_Section class.
		 */
		require_once get_template_directory() . '/plugin-notification/ti-notifications/ti-customizer-notify/class-inkthemes-customizer-notify-section.php';

		$wp_customize->register_section_type( 'Inkthemes_Customizer_Notify_Section' );

		$wp_customize->add_section(
			new Inkthemes_Customizer_Notify_Section(
				$wp_customize,
	 ...
	 */
	public function inkthemes_customizer_notify_dismiss_recommended_action_callback() {
		...
		if ( ! empty( $action_id ) ) {
			...
			if ( get_option( 'inkthemes_customizer_notify_show_recommended_actions' ) ) {
				...
				$ti_customizer_notify_show_recommended_actions = get_option( 'inkthemes_customizer_notify_show_recommended_actions' );
				switch ( $_GET['todo'] ) {
					case 'add':
				...
				update_option( 'inkthemes_customizer_notify_show_recommended_actions', $ti_customizer_notify_show_recommended_actions );
				...
				if ( ! empty( $ti_customizer_notify_recommended_actions ) ) {
					...
					update_option( 'inkthemes_customizer_notify_show_recommended_actions', $ti_customizer_notify_show_recommended_actions_new );
				}
			}
		}
	 ...
	 */
	public function inkthemes_customizer_notify_dismiss_recommended_plugins_callback() {
		...
		if ( ! empty( $action_id ) ) {
			/* if the option exists, update the record for the specified id */
			$ti_customizer_notify_show_recommended_plugins = get_option( 'inkthemes_customizer_notify_show_recommended_plugins' );
			...
			update_option( 'inkthemes_customizer_notify_show_recommended_plugins', $ti_customizer_notify_show_recommended_plugins );
		}
		die(); // this is required to return a proper result
	}
