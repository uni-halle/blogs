...
class Inkthemes_Customizer_Notify {
	...
	public function setup_actions() {
		...
		add_action( 'wp_ajax_cw_customizer_notify_dismiss_recommended_action', array( $this, 'inkthemes_customizer_notify_dismiss_recommended_action_callback' ) );

		add_action( 'wp_ajax_cw_customizer_notify_dismiss_recommended_plugins', array( $this, 'inkthemes_customizer_notify_dismiss_recommended_plugins_callback' ) );
