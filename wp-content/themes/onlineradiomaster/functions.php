...
function onlineradio_new_contactmethods( $contactmethods ) {
  ...
  $contactmethods['studip'] = 'Stud.IP Homepage<br /><small style="color:#666666;font-style:italic">nur euren Benutzernamen angeben</small>';
  
  return $contactmethods;
}
add_filter('user_contactmethods','onlineradio_new_contactmethods',10,1);
