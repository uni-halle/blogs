<?php
/**
 * The template for displaying portfolio items (2 columns).
 * It can be loaded by placing [portfolio-2col] shortcode 
 * inside your page.
 */
?>
...
<ul class="filterable-grid portfolio_group col2_portfolio">
