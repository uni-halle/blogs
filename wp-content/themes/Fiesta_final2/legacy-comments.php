<?php
if (!empty($_SERVER['SCRIPT_FILENAME']) && 'legacy-comments.php' == basename($_SERVER['SCRIPT_FILENAME']))
...
<?php endif; ?>
<?php if ('open' == $post->comment_status && (!is_page() || art_option('page.comments_allow'))) : ?>
<?php ob_start(); ?>
