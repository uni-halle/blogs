...
// Weiterleitung --- erstmal deaktiviert
/*
        ...
        <div class="wrapper">
            <header id="banner" role="banner">
                ...
                <!--<nav class="navigation right" role="navigation">
                    <ul>-->
                        <?php
                            // wp_list_categories('title_li=&hide_empty=0&depth=2&exclude=1&orderby=title');
