...
"3.2.3."         => array("de" => "Maghreb, Nordafrika (Westsahara bis Ägypten, inkl. Sudan, Malt, Nordzypern)",          "en" => "North Africa (Western Sahara to Egypt, incl. Sudan),Malta and Northern Cyprus",                "Query"=> urlencode("(sys ssg3.2.3.?)"),       "Parent"=>"3.2." ),
