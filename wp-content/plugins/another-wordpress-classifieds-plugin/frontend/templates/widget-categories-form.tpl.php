...
<p>
    ...
    <label for="<?php echo esc_attr( $this->get_field_id( 'hide-empty' ) ); ?>"><?php _e('Hide empty categories.', 'another-wordpress-classifieds-plugin'); ?></label>
    <br/>
    ...
    <label for="<?php echo esc_attr( $this->get_field_id( 'show-parents-only' ) ); ?>"><?php _e('Show parent categories only.', 'another-wordpress-classifieds-plugin'); ?></label>
    <br/>
    ...
    <label for="<?php echo esc_attr( $this->get_field_id( 'show-ad-count' ) ); ?>"><?php _e('Show Ad count.', 'another-wordpress-classifieds-plugin'); ?></label>
</p>
