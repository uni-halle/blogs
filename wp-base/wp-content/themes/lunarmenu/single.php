...
<p class="date">
<?php the_time(__('l, F dS, Y','avenue')) ?>
...
<div class="tags"><?php _e('Tags  &raquo; '); ?><?php the_tags('', ', ', ' &laquo;'); ?></div><?php endif; ?>

<div id="postmeta"><p class="data">
<a href="<?php trackback_url(display); ?>">Trackback-URL</a>&nbsp;|&nbsp;<span class="red"><?php _e('Comments Feed: ','avenue'); ?><?php comments_rss_link('RSS 2.0'); ?></span><br /><?php _e('Category: ','avenue'); ?><?php the_category(', ') ?></p>
