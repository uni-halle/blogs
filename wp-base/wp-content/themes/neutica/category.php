	...
	<div id="container">
		<div id="content">
			<div id="nav-above" class="navigation">
				<h2 class="entry-title"><?php _e('Category Archive.', 'sandbox') ?></h2>
				<div id="nav-above-content"><h2 class="entry-title"><span class="small"><?php echo single_cat_title(); ?></span></h2><?php if ( !(''== category_description()) ) : echo apply_filters('archive_meta', category_description()); endif; ?></div>
			</div>
...
<?php if ( $cats_meow = sandbox_cats_meow(', ') ) : /* Returns categories other than the one queried */ ?>
						<li><span class="cat-links"><?php printf(__('Also filed under %s', 'sandbox'), $cats_meow) ?>.</span></li>
<?php endif ?>
