...
<div class="bizzadmin">
<h2><?php echo $themename; ?> Theme Options &nbsp;&nbsp;<a id="master_switch" href="" title="Show/Hide All Options"><span class="pos"><b>+</b></span><span class="neg"><b>&#8211;</b></span> Show/Hide All Options</a></h2><br/>
...
?>
    ...
    <div class="introduction">
			...
			... Don't hesitate to submit <a href="<?php echo $kampylefeedback; ?>" onclick="window.open(this.href, 'popupwindow', 'width=438,height=500,scrollbars,resizable'); return false;">Feedback</a> to theme author
			... or ... <span class="open-new-window"><a href="<?php echo $customserviceurl; ?>" target="_blank">Request for Custom Theme Modification</a></span>
			</p>
