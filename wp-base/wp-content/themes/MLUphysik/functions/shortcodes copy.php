...
wp_mail('oliverbunke@gmail.com', 'betreff: von MLUphysik', 'der Text');
 return "<!-- IWW BOX -->
				    <h2>Stay informed</h2>
								<p>
				...
				Studieninteresse zutreffenden Informationen zusammengestellt werden. 
								...
								<p>Die Felder, die mit einem Stern (*) markiert sind, m&uuml;ssen ausgef&uuml;llt werden!<br>Nach dem Klick auf den Button &quot;Angaben speichern&quot; öffnet sich ein neues Fenster.</p>
								<form target='_blank' action='http://www.ich-will-wissen.de/interessenten/' method='POST'>
								  <input type='hidden' id='tx_kofointerested_pi1_backurl' name='tx_kofointerested_pi1[backurl]' value=''/>
								  <dl>
								    <dt><label for='tx_kofointerested_pi1_email'>E-Mail-Adresse <sup>*</sup></label></dt>
								    <dd><input type='text' id='tx_kofointerested_pi1_email' name='tx_kofointerested_pi1[email]' value=''/></dd>
								    <dt><label for='tx_kofointerested_pi1_last_name'>Nachname</label></dt>
								    <dd><input type='text' id='tx_kofointerested_pi1_last_name' name='tx_kofointerested_pi1[last_name]' value=''/></dd>
								    <dt><label for='tx_kofointerested_pi1_first_name'>Vorname</label></dt>
								    <dd><input type='text' id='tx_kofointerested_pi1_first_name' name='tx_kofointerested_pi1[first_name]' value=''/></dd>
								    ...
								    <dd><input type='checkbox' id='tx_kofointerested_pi1_agreeprivacypolicy' name='tx_kofointerested_pi1[agreeprivacypolicy]' value='1'/></dd>
								  </dl>
								  <span class='clear'></span>
								  <input type='submit' class='submitbutton' name='tx_kofointerested_pi1[submit_button]' value='Angaben speichern'/>
								</form>
				
				
				
				<script type='text/javascript'>var url=document.getElementById('tx_kofointerested_pi1_backurl');url.value=document.URL;</script>
				<br class='clear'>
				<!-- /IWW BOX -->
";
}
