...
function change_course( widget_id, ajax_handler){
	...
	jQuery.ajax({
		url: ajax_handler,
		type: 'get',
		data: 'action=getLePressTeacherWidgetBody&course_id=' + course_id + '&widget_id=' + widget_id,
		dataType: 'html',
...
function get_calendar( widget_id, course_id, month, year, ajax_handler ){
	//write ajax req using wp jquery
	jQuery.ajax({
		url: ajax_handler,
		type: 'get',
		data: 'action=getLePressTeacherWidgetCalendar&course_id=' + course_id + '&month=' + month + '&year=' + year + '&widget_id=' + widget_id,
		dataType: 'html',
		error: function( xmlHttpReq, textStatus, errorThrown  ){
			alert( 'ERROR: ' + textStatus + '\n eT: ' + errorThrown );
		},
